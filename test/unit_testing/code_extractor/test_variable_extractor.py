...
import ast
from code_extractor.variable_extractor import (
    VariableExtractor,
)
...
class TestVariableExtractor(unittest.TestCase):
    ...
    @patch("ast.walk")
    def test_extract_variable_definitions(self, mock_walk):
        ...
        mock_walk.return_value = [mock_assign_1, mock_assign_2]

        # Create an instance of VariableExtractor
    ...
    @patch("ast.walk")
    def test_track_variable_usage(self, mock_walk):
        ...
        mock_walk.return_value = [mock_name_1, mock_name_2]
    ...
    @patch("ast.walk")
    def test_empty_function(self, mock_walk):
        ...
        self.assertEqual(mock_walk.call_count, 2)  # Expect two calls in total
