...
class LibraryExtractor:
    ...
    def get_library_aliases(
        ...
        Parameters:
        - libraries (list[dict[str, str]]): A list of dictionaries as returned
          by `extract_libraries`.
    ...
    def get_library_of_node(
        ...
        Parameters:
        - node (ast.AST): The AST node to analyze. Typically represents a
          function or method call.
        - aliases (dict[str, str]): A mapping of library names to their aliases
          (as returned by `get_library_aliases`).

        Returns:
        - str: The library associated with the node, or "Unknown" if the
          library cannot be determined.
        ...
        Notes:
        - This method inspects function calls (`ast.Call`) to determine if they
          belong to a library in `aliases`.
        - For method calls (e.g., `pd.read_csv`), the method checks the base
          object (`pd`) to match it with a library.
